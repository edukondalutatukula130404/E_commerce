...
app.get('/api/health', (req, res) => {
  res.json({
    status: 'OK',
    service: 'NEXORA E-Commerce Production REST API Backend (MongoDB Atlas + JWT Auth)',
...
server.listen(PORT, async () => {
  console.log(`🚀 NEXORA Backend Server & Socket.io running on http://localhost:${PORT}`);
