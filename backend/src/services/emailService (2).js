  ...
  const htmlContent = `
    <div style="font-family: 'Segoe UI', Helvetica, Arial, sans-serif; max-width: 550px; margin: 0 auto; background-color: #0d1117; color: #f0f6fc; border-radius: 12px; padding: 24px; border: 1px solid #30363d;">
      <div style="text-align: center; padding-bottom: 20px; border-bottom: 1px solid #30363d;">
        <h1 style="color: #ba0c2f; margin: 0; font-size: 28px; font-weight: 900; letter-spacing: 1px;">NEXORA</h1>
      ...
      <div style="padding: 24px 0;">
        ...
        <p style="color: #c9d1d9; font-size: 14px; line-height: 1.6;">
          You requested to reset your password for your <strong>NEXORA</strong> account. Use the 6-digit verification code below to complete your password reset:
        </p>
      ...
      <div style="border-top: 1px solid #30363d; padding-top: 16px; text-align: center; font-size: 12px; color: #8b949e;">
        &copy; ${new Date().getFullYear()} NEXORA Official Inc. All rights reserved.
      </div>
    </div>
  `;

  const mailOptions = {
    from: '"NEXORA Security" <tatukulaedukondalu@gmail.com>',
    to: recipientEmail,
    subject: `🔐 ${otpCode} is your NEXORA Password Reset Code`,
    html: htmlContent
  };
