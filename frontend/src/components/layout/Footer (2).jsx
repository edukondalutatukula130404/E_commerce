  ...
  return (
    <footer className="footer-root-container" style={{
      ...
      <div className="app-container footer-grid-container hide-mobile" style={{
        ...
        <div>
          <div style={{ display: 'flex', alignItems: 'center', gap: '0.65rem', marginBottom: '0.75rem' }}>
            <img src="/logo.png" alt="NEXORA Logo" style={{ height: '3.2rem', width: 'auto', mixBlendMode: 'multiply' }} />
            <div>
              <h3 style={{ color: 'var(--text-main)', fontSize: '1.25rem', fontWeight: 900, lineHeight: 1 }}>
                NEXORA<span style={{ color: 'hsl(var(--hue-primary), 85%, 50%)' }}>.</span>
              </h3>
      ...
      <div className="app-container copyright-bar" style={{
        ...
        © 2026 NEXORA Inc. All rights reserved. Premium Retail Platform.
      </div>
