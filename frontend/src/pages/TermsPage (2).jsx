      ...
      <div className="card" style={{ padding: '2.5rem', display: 'flex', flexDirection: 'column', gap: '2rem', lineHeight: 1.7 }}>
        ...
        <div>
          ...
          <p style={{ color: 'var(--text-muted)', fontSize: '0.95rem' }}>
            Welcome to NEXORA E-Commerce Platform ("NEXORA", "we", "us", or "our"). By accessing or making a purchase on our website or mobile web application, you agree to be bound by these Terms & Conditions. Please read them carefully before placing an order.
          </p>
        </div>
        ...
        <div>
          ...
          <p style={{ color: 'var(--text-muted)', fontSize: '0.95rem', marginBottom: '0.75rem' }}>
            All prices displayed on NEXORA are listed in Indian Rupees (₹ INR). We reserve the right to modify prices, discount promos, or availability without prior notice.
          </p>
          <ul style={{ listStyle: 'none', display: 'flex', flexDirection: 'column', gap: '0.5rem', color: 'var(--text-muted)', fontSize: '0.9rem', paddingLeft: '1rem' }}>
            ...
            <li>• Promotional coupon codes (e.g. NEXORA10, NEXORA20) are single-use per customer session.</li>
          </ul>
        </div>
        ...
        <div>
          ...
          <p style={{ color: 'var(--text-muted)', fontSize: '0.95rem' }}>
            All hardware devices sold on NEXORA include our 2-Year Hardware Warranty against defects. NEXORA's total liability for any claim shall not exceed the price paid for the specific item purchased.
          </p>
        </div>
        ...
        <div style={{ padding: '1.25rem', borderRadius: 'var(--radius-md)', background: 'var(--bg-secondary)', border: '1px solid var(--border-light)' }}>
          ...
          <p style={{ fontSize: '0.85rem', color: 'var(--text-muted)' }}>
            Contact our legal compliance team at <strong style={{ color: 'var(--text-main)' }}>legal@nexora.io</strong>
          </p>
        </div>
