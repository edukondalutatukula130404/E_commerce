...
export const BlogsPage = () => {
  ...
  const blogs = [
    {
      id: "b1",
      title: "The Architecture of Sub-Second E-Commerce: How We Built NEXORA",
      category: "Tech",
      readTime: "5 min read",
      date: "July 20, 2026",
      author: "Alex Mercer",
      ...
      content: `In the modern digital landscape, millisecond delays convert directly to lost revenue. When building NEXORA, our engineering goal was simple: achieve zero-friction UI rendering across any viewport size from a 320px mobile phone to a 4K desktop display.
...
Utilizing HSL CSS custom properties and \`backdrop-filter: blur(14px)\`, NEXORA delivers futuristic glass surfaces with a clean light aesthetic.`
    },
    {
      id: "b2",
    ...
    <div className="animate-fade-in" style={{ paddingTop: '1rem', paddingBottom: '4rem' }}>
      ...
      <div style={{ textAlign: 'center', marginBottom: '2.5rem' }}>
        ...
        <h1 style={{ fontSize: 'clamp(1.8rem, 4vw, 2.5rem)', fontWeight: 800, marginBottom: '0.5rem' }}>
          NEXORA Insights & Engineering Blog
        </h1>
