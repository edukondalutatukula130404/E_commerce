...
export const HomePage = () => {
  ...
  const handleCopy = () => {
    setCopied(true);
    if (typeof showToast === 'function') showToast('✓ Promo Code NEXORA20 copied!');
  ...
  const testimonials = [
    ...
    },
    {
      ...
      quote: "NEXORA ordering process was seamless. Express dispatch delivered my Horizon Smartwatch in under 48 hours!",
  ...
  const faqs = [
    {
      id: 1,
      question: "How fast is NEXORA Express Dispatch?",
      answer: "All orders placed before 2 PM EST are dispatched same-day with real-time GPS tracking enabled."
    },
    {
      id: 2,
      question: "What warranty comes with NEXORA hardware?",
      answer: "Every electronic device and wearable includes our 2-Year NEXORA Hardware Replacement Coverage."
    },
    {
      id: 3,
      question: "How do I apply VIP discount promo codes?",
      answer: "You can apply promo codes like NEXORA10 or NEXORA20 directly during 2-step checkout."
    }
  ];
  ...
  return (
    <div className="animate-fade-in" style={{ display: 'flex', flexDirection: 'column', gap: '1.25rem', paddingTop: '0.75rem', width: '100%', overflowX: 'hidden' }}>
      ...
      <section className="card" style={{
        ...
        <div style={{ flex: 1, maxWidth: '600px', position: 'relative', zIndex: 2 }}>
          <div style={{ display: 'inline-flex', alignItems: 'center', gap: '0.4rem', marginBottom: '0.75rem' }} className="badge badge-primary">
            <img src="/logo.png" alt="NEXORA" style={{ height: '1rem', width: 'auto' }} />
            <span>NEXORA OFFICIAL — SINCE 2026</span>
          </div>
        ...
        <div className="hero-product-image-container" style={{ flex: '0 0 360px', maxWidth: '360px', position: 'relative', zIndex: 2 }}>
          <div style={{ position: 'relative', cursor: 'pointer' }} onClick={() => setCurrentPage('catalog')}>
            <img
              ...
              alt="NEXORA 3D E-Commerce Shopping Showcase"
              style={{
                width: '100%',
                height: '250px',
                objectFit: 'cover',
            ...
            <div style={{
              ...
              <span style={{ fontSize: '0.75rem', fontWeight: 800 }}>NEXORA Retail Platform</span>
      ...
      >
        <div style={{ display: 'flex', alignItems: 'center', gap: '1rem', flex: 1, minWidth: '220px' }}>
          ...
          <div>
            ...
            <h3 style={{ fontSize: 'clamp(0.95rem, 3.2vw, 1.15rem)', fontWeight: 800, margin: 0, color: '#ffffff', lineHeight: 1.3 }}>
              Claim Your Exclusive Hardware Discount with <span style={{ color: '#fbbf24', fontFamily: 'monospace', textDecoration: 'underline' }}>NEXORA20</span>
            </h3>
          </div>
        </div>
        ...
        >
          {copied ? '✓ Code Copied!' : 'Copy Code NEXORA20'}
        </button>
      </section>

      {/* 3. Featured NEXORA Products Carousel */}
      <section style={{ width: '100%' }}>
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '0.85rem', flexWrap: 'wrap', gap: '0.5rem' }}>
          <div>
            <h2 style={{ fontSize: 'clamp(1.15rem, 3.5vw, 1.45rem)', fontWeight: 800 }}>Featured NEXORA Products</h2>
      ...
      <section className="card" style={{ padding: '1.5rem', width: '100%', background: 'linear-gradient(135deg, var(--bg-card) 0%, var(--bg-secondary) 100%)' }}>
        <div style={{ maxWidth: '680px', marginBottom: '1.25rem' }}>
          ...
          <p style={{ fontSize: '0.85rem', color: 'var(--text-muted)', lineHeight: 1.6 }}>
            Every product in the NEXORA ecosystem is crafted to deliver optimal ergonomics, premium material feel, and zero-compromise hardware durability.
          </p>
        </div>
