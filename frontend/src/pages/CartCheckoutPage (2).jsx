        ...
        <div style={{
          ...
          <div className="card animate-fade-in" style={{
            ...
            <p style={{ fontSize: '0.875rem', color: 'var(--text-muted)' }}>
              Thank you for shopping with NEXORA! Your order ID is <strong style={{ color: 'var(--text-main)' }}>#{confirmedOrder.id || confirmedOrder.orderId}</strong>.
            </p>
