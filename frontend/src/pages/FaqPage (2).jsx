  ...
  const faqs = [
    {
      ...
      icon: Truck,
      question: "How fast is NEXORA express shipping?",
    ...
    },
    {
      ...
      icon: ShieldCheck,
      question: "Do NEXORA products come with a warranty?",
    ...
    },
    {
      ...
      answer: "You can enter your promo code in the checkout drawer or cart summary page. Try using code 'NEXORA10' for 10% off or 'NEXORA20' for VIP discount."
    }
  ];
    ...
    <div className="animate-fade-in" style={{ paddingTop: '1rem', paddingBottom: '4rem', maxWidth: '840px', margin: '0 auto' }}>
      ...
      <div style={{ textAlign: 'center', marginBottom: '2.5rem' }}>
        ...
        <p style={{ fontSize: '1rem', color: 'var(--text-muted)' }}>
          Got questions? We're here to help you get the most out of your NEXORA experience.
        </p>
      </div>
