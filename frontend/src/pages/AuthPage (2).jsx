...
export const AuthPage = () => {
  ...
  const handleDemoLogin = (role) => {
    if (role === 'admin') {
      loginWithCredentials('admin@nexora.io', 'admin123');
    } else {
      loginWithCredentials('alex@nexora.io', 'user123');
    }
  };
    ...
    <div className="animate-fade-in" style={{ paddingTop: '1rem', paddingBottom: '4rem', display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
      ...
      <div className="card" style={{ width: '100%', maxWidth: '440px', padding: '2rem', display: 'flex', flexDirection: 'column', gap: '1.25rem' }}>
        ...
        <div style={{ textAlign: 'center' }}>
          <img src="/logo.png" alt="NEXORA Logo" style={{ height: '3.5rem', width: 'auto', marginBottom: '0.4rem', mixBlendMode: 'multiply' }} />
          <h2 style={{ fontSize: '1.4rem', fontWeight: 900 }}>
            {user ? 'My Account' : (isRegister ? 'Create Account' : 'Welcome to NEXORA')}
          </h2>
