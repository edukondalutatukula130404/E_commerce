...
1. **User Interaction**: User triggers an action (e.g., clicks "Add to Cart", filters by "Electronics").
2. **Context Dispatch**: The action triggers a reducer dispatch event (`ADD_TO_CART`, `SET_SEARCH_QUERY`).
